                ...
                <div className="flex items-center gap-2">
                    <div className="flex bg-slate-900 p-1 rounded-xl border border-slate-800">
                        <button
                            ...
                            className={`p-1.5 rounded-lg transition-all ${chartType === 'pie' ? 'bg-orange-500/20 text-orange-400 border border-orange-500/30' : 'text-slate-500 hover:text-slate-300'}`}
                            title="תרשים עוגה"
                        >
                            <PieIcon size={14} />
                        </button>
                        <button
                            ...
                            className={`p-1.5 rounded-lg transition-all ${chartType === 'bar' ? 'bg-orange-500/20 text-orange-400 border border-orange-500/30' : 'text-slate-500 hover:text-slate-300'}`}
                            title="תרשים עמודות"
                        >
                            <LayoutGrid size={14} />
                        </button>
