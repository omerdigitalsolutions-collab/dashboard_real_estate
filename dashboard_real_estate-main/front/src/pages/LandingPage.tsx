            ...
            <section id="training" className="py-24 bg-gradient-to-br from-emerald-50 via-white to-teal-50 border-t border-emerald-100/80" dir="rtl">
                <div className="max-w-5xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="flex justify-center mt-8">
                        <a 
                            href="https://homer.management/contact" 
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="bg-white hover:bg-emerald-50 text-emerald-600 border border-emerald-200 font-black text-xl md:text-2xl px-12 py-6 rounded-full shadow-xl shadow-emerald-500/10 transition-all hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-4"
                        >
                            <GraduationCap className="w-8 h-8" />
                            לקביעת הדרכה לחצו כאן
                        </a>
                    </div>
                </div>
            </section>
