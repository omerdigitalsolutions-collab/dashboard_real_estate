...
Return ONLY a valid parseable JSON array of objects. Do not use markdown wrapping (\`\`\`json) in the response. Ignore empty rows.`;
            ...
            throw new https_1.HttpsError('invalid-argument', 'Unsupported entityType. Must be properties or leads.');
        }
        ...
        try {
            ...
            throw new https_1.HttpsError('internal', 'AI did not return valid JSON array.');
        }
        ...
        throw new https_1.HttpsError('internal', 'AI Data Extraction failed. Check logs for details.');
    }
});
