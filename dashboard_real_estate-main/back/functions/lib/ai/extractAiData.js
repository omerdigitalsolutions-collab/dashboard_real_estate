...
exports.extractAiData = (0, https_1.onCall)({
    ...
    if (!apiKey) {
        ...
        throw new https_1.HttpsError('internal', 'AI Data Extraction is unavailable.');
    }
    try {
...
Return ONLY a valid parseable JSON array of objects. Do not use markdown wrapping (\`\`\`json) in the response.`;
            ...
            throw new https_1.HttpsError('invalid-argument', 'Unsupported entityType. Must be properties, leads, combined, or mixed.');
        }
        ...
        try {
            ...
            throw new https_1.HttpsError('internal', `AI did not return valid JSON array. Response: ${responseText.substring(0, 100)}...`);
        }
        ...
        throw new https_1.HttpsError('internal', `AI Data Extraction failed: ${msg}. Check logs for details.`);
    }
});
//# sourceMappingURL=extractAiData.js.map