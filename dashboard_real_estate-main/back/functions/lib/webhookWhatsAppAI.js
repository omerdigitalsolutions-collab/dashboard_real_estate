...
exports.webhookWhatsAppAI = (0, https_1.onRequest)({
    ...
    try {
        ...
        const idInstance = (_a = body === null || body === void 0 ? void 0 : body.idInstance) === null || _a === void 0 ? void 0 : _a.toString();
        if (!idInstance) {
        ...
        if (typeWebhook === 'outgoingMessageReceived') {
            ...
            const recipientRawId = ((_b = body === null || body === void 0 ? void 0 : body.chatData) === null || _b === void 0 ? void 0 : _b.chatId) || ((_c = body === null || body === void 0 ? void 0 : body.senderData) === null || _c === void 0 ? void 0 : _c.chatId) || '';
        ...
        const textMessage = ((_d = messageData.textMessageData) === null || _d === void 0 ? void 0 : _d.textMessage) || '';
        ...
        const catalogId = await createSharedCatalog(agencyId, agencyData, leadId, leadName, propertyIds);
